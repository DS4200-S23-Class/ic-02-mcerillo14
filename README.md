...
1. Create a GitHub Page for your repo and add the link to it above where you see "https://ds4200-s23-class.github.io/ic-02-mcerillo14/". When you do this you should replace all text between the "[]", but keep the "[]" -- this will result in a clickable hyperlink in the browser.  
